...
public class inscriptionClient extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		String loginParam = request.getParameter("loginParam");
                ...
                String codePostalParam = request.getParameter("codePostalParam");
		...
		try {
                    ...
                    res = dao.ajoutClient(passwordParam,societeParam,loginParam,fonctionParam,adresseParam,villeParam,regionParam,codePostalParam,paysParam,telParam,faxParam);	
